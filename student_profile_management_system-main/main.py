...
def renderAddWindow():
    ...
    addWindow = Tk()
    addWindow.title('Add Window - Student Management System')
...
def renderEditWindow(selectedStudData):
    ...
    conn.close()
    editWindow = Tk()
    editWindow.title('Edit Window - Student Management System')
...
def renderViewWindow(selectedStudData):
    ...
    viewWindow = Tk()
    viewWindow.title('View Window - Student Management System')
...
mainWindow = Tk()
mainWindow.title('Home - Student Management System')
